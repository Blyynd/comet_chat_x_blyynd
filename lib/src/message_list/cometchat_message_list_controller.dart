...
class CometChatMessageListController
  ...
  // onForwardSubmitTap(BaseMessage forwardingMessage , List<User>? userList, List<Group>? groupList ) async {
  //
  //   Navigator.of(context).pop();
  //
  //
  //
  //   SnackBarUtils.show(cc.Translations.of(context).forwarding_message , context,snackBarConfiguration:  snackBarConfiguration, theme: theme);
  //
  //   CometChatMessageEvents.ccMessageForwarded(forwardingMessage, userList, groupList, MessageStatus.inProgress);
  //
  //
  //
  //   if(userList!=null){
  //     await Future.forEach<User>(userList, (user ) async { await createMessage(forwardingMessage,user, null );});
  //   }
  //   if(groupList!=null){
  //     await Future.forEach<Group>(groupList, (group ) async { await createMessage(forwardingMessage,null, group );});
  //   }
  //
  //   if( ( (userList?.length??0) + (groupList?.length??0)) == 1 ){
  //
  //        Navigator.of(context).pop(threadMessageParentId ==0 ?0:1 );
  //   }
  //
  //   CometChatMessageEvents.ccMessageForwarded(forwardingMessage, userList, groupList, MessageStatus.sent);
  //
  // }

  // _forwardMessage(BaseMessage message, CometChatMessageListControllerProtocol state) {
  //
  //   UsersConfiguration defaultUsersConfiguration  =  UsersConfiguration(
  //     activateSelection: ActivateSelection.onClick,
  //       selectionMode: SelectionMode.multiple,
  //       usersRequestBuilder: RequestBuilderConstants.getDefaultUsersRequestBuilder()
  ...
  //       activateSelection: ActivateSelection.onClick,
  //       selectionMode: SelectionMode.multiple,
  //       groupsRequestBuilder: RequestBuilderConstants.getDefaultGroupsRequestBuilder()
  //         ..joinedOnly = true
  //   );
  //
  //
  ...
  //         onClose: forwardMessageConfiguration?.onClose ??
  //                 () {
  //               Navigator.of(context).pop();
  //             },
  //         closeIcon: forwardMessageConfiguration?.closeIcon ??
  //             Image.asset(
  //               AssetConstants.close,
  //               package: UIConstants.packageName,
  //               color: theme?.palette.getPrimary(),
  //             ),
  //         title: forwardMessageConfiguration?.title ,
  //         usersConfiguration:
  //         forwardMessageConfiguration?.usersConfiguration?.merge(defaultUsersConfiguration)
  //             ??defaultUsersConfiguration,
  //         theme: forwardMessageConfiguration?.theme ?? theme,
  //         groupsConfiguration:
  //         forwardMessageConfiguration?.groupsConfiguration?.merge(defaultGroupsConfiguration)
  //             ??defaultGroupsConfiguration,
  //         groupsTabTitle:
  //         forwardMessageConfiguration?.groupsTabTitle ?? cc.Translations.of(context).groups,
  //         contactsStyle:
  //         forwardMessageConfiguration?.contactsStyle ??
  //             const ContactsStyle(),
  //         usersTabTitle: forwardMessageConfiguration?.usersTabTitle ?? cc.Translations.of(context).users,
  //         hideSubmitIcon:forwardMessageConfiguration?.hideSubmitIcon??false ,
  //         onSubmitIconTap: (BuildContext context , List<User>?  selectedUsersList, List<Group>? selectedGroupsList ){
  //           onForwardSubmitTap(message , selectedUsersList,  selectedGroupsList );
  //         },
  //         selectionLimit: forwardMessageConfiguration?.selectionLimit,
  //         selectionMode: forwardMessageConfiguration?.selectionMode?? SelectionMode.none,
  //         submitIcon: forwardMessageConfiguration?.submitIcon,
  //         tabVisibility: forwardMessageConfiguration?.tabVisibility??TabVisibility.usersAndGroups,
  //         snackBarConfiguration: forwardMessageConfiguration?.snackBarConfiguration??snackBarConfiguration,
  //
  //       ),
  //     ),
  //   ).then((value) {
  //     if(value!=null && value!=0 && value is int){
  ...
  // _replyInThread(BaseMessage message, CometChatMessageListControllerProtocol state) {
  ...
  BubbleContentVerifier checkBubbleContent(
    ...
    return BubbleContentVerifier(
        ...
        showFooterView: enableFooterView,
        showName: name,
